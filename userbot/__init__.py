...
UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "KEN-UBOT")
...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/a71eaab2f97927e553885.jpg"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/a71eaab2f97927e553885.jpg"
)
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**KEN-UBOT v{BOT_VER} is running!**\n\n"
...
with bot:
    try:
        ...
        async def handler(event):
            ...
            text = (
                f"**Hey** I am using **KEN-UBOT**\n\n"
                f"> **Userbot Version :** `{BOT_VER}@{UPSTREAM_REPO_BRANCH}`\n"
                f"> **Group Support :** [Emiko support](t.me/emikosupport)\n"
                f"> **Owner Repo :** [Sen-ex](t.me/excrybaby)\n"
                f"> **Repo :** [KEN-UBOT](https://github.com/kennedy-ex/KEN-UBOT)\n"
            )
            await tgbot.send_file(
                ...
                buttons=[
                    [
                        custom.Button.url(
                            text="• Repo •",
                            url="https://github.com/kennedy-ex/KEN-UBOT",
                        )
                    ],
                    [
                        custom.Button.url(
                            text="• Group", url="https://t.me/emikosupport"
                        ),
                        custom.Button.url(
                            text="Channel •", url="https://t.me/kennedyproject"
                        ),
                    ],
                ],
            )
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@SharingUserbot"):
                ...
                result = builder.photo(
                    file=logoken,
                    link_preview=False,
                    text=f"**Bot of [{user.first_name}](tg://user?id={user.id})**\n\n• **Jumlah Modules**: `{len(dugmeler)}` modules\n\n• Join [Group support](https://t.me/emikosupport)",
                    buttons=buttons,
                )
                ...
                result = builder.article(
                    ...
                    url="https://t.me/emikosupport",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text="**KEN - UBOT**\n• **Owner Repo :** [Sena-ex](https://t.me/excrybaby)\n• **Support :** @kennedyproject\n• **Repository :** [KEN-UBOT](https://github.com/kennedy-ex/KEN-UBOT)",
                    buttons=[
                        [
    ...
    try:
        ...
        LOGS.info(
            "var BOTLOG_CHATID kamu belum di isi. "
            "Buatlah grup telegram dan masukan bot @emiexrobot lalu ketik /id "
            "Masukan id grup nya di var BOTLOG_CHATID"
        )
        sys.exit(1)
