...
from userbot.clients import ken_userbot_on, multiclient
...
try:
    ...
    LOGS.info(f"KEN-UBOT Version - {ubotversion} [ ⚡ Is Now Online ⚡ ]")
...
bot.loop.run_until_complete(ken_userbot_on())
if not BOT_TOKEN:
